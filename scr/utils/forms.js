...
export const validateInput = (name, value, repit) => {
    let hasError = false;
    let error = "";
    switch (name) {
        case "email":
...
export const onFocusOut = (name, value, dispatch, formState, repit) => {
    const { hasError, error } = validateInput(name, value, repit);
    let isFormValid = true;
